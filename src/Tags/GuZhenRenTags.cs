...
public sealed class GuZhenRenTags
{
    ...
    public static readonly CardTag GuDao =
        ModContentRegistry.GetQualifiedCardTagId(Entry.ModId, nameof(GuDao)).GetModCardTag();

    public static readonly CardTag GuChongDao =
        ModContentRegistry.GetQualifiedCardTagId(Entry.ModId, nameof(GuChongDao)).GetModCardTag();
    ...
    public static readonly CardTag JinDao =
        ModContentRegistry.GetQualifiedCardTagId(Entry.ModId, nameof(JinDao)).GetModCardTag();
    ...
    public static readonly CardTag TouDao =
        ModContentRegistry.GetQualifiedCardTagId(Entry.ModId, nameof(TouDao)).GetModCardTag();
    ...
    public static readonly CardTag ZhouDao =
        ModContentRegistry.GetQualifiedCardTagId(Entry.ModId, nameof(ZhouDao)).GetModCardTag();
}
