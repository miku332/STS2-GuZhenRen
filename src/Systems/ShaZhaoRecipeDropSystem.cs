...
internal static class ShaZhaoRecipeDropSystem
{
    ...
    [
        ...
        ModelDb.Relic<RecipeLuanFangHunXiangWu>(),
        ModelDb.Relic<RecipeNiePanHuo>(),
        ModelDb.Relic<RecipeRanNianFeiShi>(),
        ...
        ModelDb.Relic<RecipeXueRanZhengPao>(),
